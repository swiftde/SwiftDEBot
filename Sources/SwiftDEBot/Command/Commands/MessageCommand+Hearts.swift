extension MessageCommand {
    static func heartsMessage(to user: String) -> String {
        ...
        Das von dir genutzte ♥️ ist allerdings Teil des Sets von Symbolen für Spielkarten, zusammen mit ♠️, ♣️ und ♦️ und ist daher eher unpassend in anderen Kontexten.
        """
    }
